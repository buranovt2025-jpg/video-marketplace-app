...
- [x] Создание карточек товаров
- [x] Создание рилсов (видео)
- [x] Создание историй (24 часа)
- [x] Просмотр своих заказов
- [x] Чат с покупателями (базовый)
- [x] Принять/отклонить заказ (кнопки)
- [x] Изменение статуса заказа (принят/готов к выдаче)
- [x] Статистика (базовая)
- [x] Управление остатками товара (базовое: наличие/количество)

### Покупатель
- [x] Регистрация/вход
- [ ] Профиль с адресом доставки (локация)
- [x] Просмотр ленты рилсов
- [x] Просмотр историй (кружочки)
- [x] Поиск (Instagram Explore style - сетка фото/видео)
- [x] Просмотр карточек товаров
- [x] Оформление заказа
- [x] Отслеживание статуса заказа
- [x] Чат с продавцом (базовый)
- [ ] Несколько адресов доставки (дом/работа)
- [x] Избранное (сохранённые товары)
- [ ] Кнопка "Проблема с заказом" (жалоба)
- [x] Убрать вкладку "Создать" (только для продавцов)
...
### 4. Заказы
- [x] Оформление заказа (товар + количество)
- [x] Выбор способа оплаты (наличка курьеру)
...
### 5. Чат
- [x] Список диалогов
- [x] Экран чата (сообщения)
- [x] Отправка текста
- [x] Отправка фото (через imageUrl)
...
### Цветовая схема
- [x] Основной: Оранжевый (#FF6B00)
- [x] Фон: Чёрный (#000000)
- [x] Текст: Белый (#FFFFFF)
