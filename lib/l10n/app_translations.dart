...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'ru_RU': {
      ...
      'notif_new_order_message': 'Вы получили новый заказ #{id}',
      'notif_order_delivered_title': 'Заказ доставлен',
      'notif_order_delivered_message': 'Ваш заказ #{id} успешно доставлен',
      'notif_new_review_title': 'Новый отзыв',
      'notif_new_review_message': 'Покупатель оставил отзыв на ваш товар',

      // Reports
      'select_report_reason': 'Выберите причину жалобы',
      'additional_info': 'Дополнительная информация',
      'report_details_hint': 'Опишите проблему подробнее (необязательно)...',
      'send_report': 'Отправить жалобу',

      // Delete account (flow)
      'confirm_delete_account_required': 'Подтвердите удаление аккаунта',
      ...
      'account_deleted_error': 'Ошибка при удалении аккаунта',
      'account_deletion_title': 'Удаление аккаунта',
      'after_delete_you_lose': 'После удаления аккаунта вы потеряете:',
    ...
    'uz_UZ': {
      ...
      'notif_new_order_message': 'Siz yangi buyurtma oldingiz #{id}',
      'notif_order_delivered_title': 'Buyurtma yetkazildi',
      'notif_order_delivered_message': 'Buyurtmangiz #{id} muvaffaqiyatli yetkazildi',
      'notif_new_review_title': 'Yangi sharh',
      'notif_new_review_message': 'Xaridor mahsulotingizga sharh qoldirdi',

      // Reports
      'select_report_reason': 'Shikoyat sababini tanlang',
      'additional_info': 'Qo\'shimcha ma\'lumot',
      'report_details_hint': 'Muammoni batafsil yozing (ixtiyoriy)...',
      'send_report': 'Shikoyat yuborish',

      // Delete account (flow)
      'confirm_delete_account_required': 'Akkauntni o\'chirishni tasdiqlang',
      'enter_password_to_confirm': 'Tasdiqlash uchun parolni kiriting',
      'delete_account_question': 'Akkaunt o\'chirilsinmi?',
      'delete_account_irreversible': 'Bu amalni qaytarib bo\'lmaydi. Barcha ma\'lumotlaringiz o\'chiriladi.',
      'account_deleted_success': 'Akkaunt muvaffaqiyatli o\'chirildi',
      'account_deleted_error': 'Akkauntni o\'chirishda xato',
      'account_deletion_title': 'Akkauntni o\'chirish',
      'after_delete_you_lose': 'O\'chirgandan so\'ng yo\'qotasiz:',
      'delete_item_orders_history': 'Barcha buyurtmalar va tarix',
      'delete_item_favorites': 'Sevimlilar',
      'delete_item_saved_addresses': 'Saqlangan manzillar',
      'delete_item_reviews_ratings': 'Sharhlar va baholar',
      'delete_item_my_products': 'Barcha mahsulotlaringiz',
      'delete_item_reels_stories': 'Rilslar va storilar',
      'delete_item_sales_stats': 'Sotuv statistikasi',
      'delete_reason_title': 'O\'chirish sababi',
      'select_reason': 'Sababni tanlang',
      'delete_reason_not_using': 'Endi foydalanmayman',
      'delete_reason_found_other': 'Boshqa platforma topdim',
      'delete_reason_app_issues': 'Ilova muammolari',
      'delete_reason_privacy': 'Maxfiylik',
      'delete_reason_other': 'Boshqa',
      'describe_reason_hint': 'Sababni yozing...',
      'confirm_with_password': 'Parol bilan tasdiqlang',
      'enter_password_hint': 'Parolni kiriting',
      'irreversible_ack': 'Bu amal qaytarilmasligini tushunaman',

      // Rate order
      'select_rating': 'Bahoni tanlang',
      'review_hint': 'Tajriba haqida yozing...',
      'rating_1': 'Juda yomon',
      'rating_2': 'Yomon',
      'rating_3': 'Normal',
      'rating_4': 'Yaxshi',
    ...
    'en_US': {
      ...
      'notif_new_order_message': 'You received a new order #{id}',
      'notif_order_delivered_title': 'Order delivered',
      'notif_order_delivered_message': 'Your order #{id} was delivered',
      'notif_new_review_title': 'New review',
      'notif_new_review_message': 'A buyer left a review on your product',

      // Reports
      'select_report_reason': 'Select a report reason',
      'additional_info': 'Additional information',
      'report_details_hint': 'Describe the issue in more detail (optional)...',
      'send_report': 'Send report',

      // Delete account (flow)
      'confirm_delete_account_required': 'Confirm account deletion',
      'enter_password_to_confirm': 'Enter password to confirm',
      'delete_account_question': 'Delete account?',
      'delete_account_irreversible': 'This action cannot be undone. All your data will be deleted permanently.',
      'account_deleted_success': 'Account deleted successfully',
      'account_deleted_error': 'Failed to delete account',
      'account_deletion_title': 'Account deletion',
      'after_delete_you_lose': 'After deletion you will lose:',
      ...
      'delete_item_my_products': 'All your products',
      'delete_item_reels_stories': 'Reels and stories',
      'delete_item_sales_stats': 'Sales statistics',
      'delete_reason_title': 'Deletion reason',
      'select_reason': 'Select a reason',
      'delete_reason_not_using': 'Not using anymore',
      'delete_reason_found_other': 'Found another platform',
      'delete_reason_app_issues': 'App issues',
      'delete_reason_privacy': 'Privacy',
      'delete_reason_other': 'Other',
      'describe_reason_hint': 'Describe the reason...',
      'confirm_with_password': 'Confirm with password',
      'enter_password_hint': 'Enter password',
      'irreversible_ack': 'I understand this action is irreversible',
